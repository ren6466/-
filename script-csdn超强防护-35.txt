...
cdstyle.innerHTML = `#article,.article_content,#content_views,.main-content .user-article{height: auto !important;overflow: auto !important;}
.article_content{overflow:visible !important; height:auto !important;}
#sskbj{
    position: fixed;
    left: calc(10% - 10px);
    width: 80%;
...
divv.id = "sskbj";
divv.innerHTML = `<form action='https://so.csdn.net/wap'>
